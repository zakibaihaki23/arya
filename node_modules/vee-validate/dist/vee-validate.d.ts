import { ComputedRef, Ref, WritableComputedRef, DefineComponent, VNode, RendererNode, RendererElement, Slot, ComponentOptionsMixin, VNodeProps, AllowedComponentProps, ComponentCustomProps, PropType } from 'vue';
...
interface PublicFormContext<TValues extends Record<string, any> = Record<string, any>> extends Omit<FormContext<TValues>, 'register' | 'unregister' | 'fields' | 'schema' | 'validateSchema' | 'errorBag' | 'setFieldErrorBag' | 'stageInitialValue'> {
 ...
 */
declare function useFieldValue<TValue = unknown>(path?: MaybeReactive<string>): ComputedRef<TValue>;

/**
 * Gives access to a form's values
 */
declare function useFormValues<TValues extends Record<string, unknown> = Record<string, unknown>>(): ComputedRef<Partial<TValues>>;
