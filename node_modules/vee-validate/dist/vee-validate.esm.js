 ...
 */
function useFormMeta(fields, errors, currentValues, initialValues) {
    ...
    return computed(() => {
        ...
        return Object.assign(Object.assign({ initialValues: unref(initialValues) }, flags), { dirty: isDirty.value, valid: isValid.value });
    });
}
